...
SECRET_KEY = 'django-insecure-@r(sf^2p^b9l15t^(+cps#e+vvjp3tl^55iyj#i*!8*ih=h6bk'
...
ALLOWED_HOSTS = [
    ...
    'robotfoodes-env.eba-ir4nunpm.us-east-1.elasticbeanstalk.com'
]
...
DATABASES = {
    ...
    'default': {
        ...
        'USER': "postgres",
        'PASSWORD': "postgres",
        'HOST': "aa1hwd16d753m5q.ceyhg4pgsozs.us-east-1.rds.amazonaws.com",    # Ze
        'PORT': "5432",
    }
}
